...
const FormBanner = ({ heading, paragraph, modalType }: FormBannerProps) => {
  return (
    <div className="form-slider-container form-banner lg:relative flex lg:justify-between lg:items-center lg:mx-auto lg:py-20 lg:flex-row flex-col flex-col-reverse">
