...
interface StudentConversation {
  ...
  complaintCreatedBy: string;
  complaintCreatedOn: string;
}
...
const studentConversations: StudentConversation[] = [
  {
    id: 1,
    complaintId: "TWM11NNU",
    email: "anci@yopmail.com",
    name: "Shivam test",
    mobile: +91 - 1987984654,
    complaintStatus: "Open",
    complaintFor: "Ambala",
    complaintSubject: "Leave",
    complaintMessage: " asdfasdfasdf asfasfasdfsfew qwerwqr",
    complaintCreatedBy: "Self",
    complaintCreatedOn: "21-03-2025 05:31 PM",
  },
];
...
export default StudentComlaintModal;
