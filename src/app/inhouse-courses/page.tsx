                ...
                <div className="m-auto w-3/4 mt-10 form-middle-container">
                    ...
                    {showCourseForm && (
                        ...
                        >
                            ...
                            <div className="common-button-rows w-1/2 m-auto">
                                ...
                                <Button onClick={handleSearch} className="ml-4 !p-0" variant="link">
                    ...
                    {searchClicked && !showCourseForm && (
                        <div className="advanced-reset-btn flex gap-5">
                            <Button onClick={handleAdvancedSearch} className="advanced-search">Advanced Search</Button>
                            <Button
                                onClick={() => {
                        ...
                        <Form {...form}>
                            <form className="flex flex-col gap-10">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="form-row w-full">
                                                ...
                                                <Select onValueChange={handleModuleTypeChange} value={selectedModuleType ?? ""}>
                                                    <SelectTrigger>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem className="form-row w-full">
                                                ...
                                                <Select onValueChange={handleCourseTypeChange} value={selectedCourseType ?? ""}>
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Select Course Type" />
                                                    </SelectTrigger>
                                                    <SelectContent>
                                                        <SelectItem value="Morning Course">Morning Course</SelectItem>
                                                        <SelectItem value="Day Course">Day Course</SelectItem>
                                                        <SelectItem value="Evening Course">Evening Course</SelectItem>
                                                    </SelectContent>
                                                </Select>
                                                <FormMessage />
                                            </FormItem>
                                ...
                                <div className="common-button-rows">
                                    <Button className="!p-0" onClick={handleBackAdvanced} variant="link">
                                        <i className="fa fa-angle-left"></i> Back
                                    </Button>
                                    <Button
                                        className="!p-0"
                                ...
                                <Card className="courses-box p-4 rounded-xl border bg-card shadow">
                                    <CardContent className="p-0">
                                        ...
                                        <div className="courses-list">
                                            <ul className="my-5">
                                                <li><p>Branch: {courses.branch}</p></li>
                                                <li><p>Module: {courses.module}</p></li>
                                                <li><p>Course Type: {courses.coursestype}</p></li>
                                                <li><p>Duration: {courses.durations}</p></li>
                                                <li><p>Price: {courses.price}</p></li>
                                            </ul>
                                        </div>
                                        <div className="courses-btn-box flex justify-between items-center">
                                            <p className="!text-sm">{courses.moreinfo}</p>
                                            <Button className="courses-btn">Buy Now: {courses.buynow}</Button>
                                        </div>
                                    </CardContent>
                                </Card>
                            </div>
